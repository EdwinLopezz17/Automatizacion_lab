...
class AppSitService:
    ...
    def get_app_sit_user(self, usuario: str) -> AppSitUser:
        ...
        return self._cache.get(key, AppSitUser( usuario = "", isActivo = False, full_name = "",
